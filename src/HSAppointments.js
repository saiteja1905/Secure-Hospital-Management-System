                                        ...
                                        <div className="appointment-list">
                                            <div className="profile-info-widget">
                                                <a className="booking-doc-img">
                                                    <img src={appt.patient_id.image}/>
                                                </a>
                                                <div className="profile-det-info">
                                                    <h3><a onClick={() => history.push("/PatientProfile/" + appt.patient_id)} className="bg-success-light">{appt.patient != null && appt.patient.username != null && appt.patient.username}</a></h3>
                                                    <div className="patient-details">
                                                        <h5><i className="far fa-clock"></i> {appt.d} {appt.m} {appt.y}, {appt.time}</h5>
                                                        <h5><i className="fas fa-map-marker-alt"></i> {appt.patient != null && appt.patient.address}
                                                        </h5>
                                                        <h5><i className="fas fa-envelope"></i> {appt.patient != null && appt.patient.email}</h5>
                                                        <h5 className="mb-0"><i className="fas fa-phone"></i> +1 {appt.patient != null && appt.patient.phone}</h5>
                                                    </div>
                                                </div>
                                            </div>
                                            <div className="appointment-action">
                                                <a className={"btn btn-sm bg-info-light" + statusToClass[appt.status].class}>{statusToClass[appt.status].text}</a>
                                                ...
                                                {
                                                    (appt.status == 2) &&
                                                    <a className="btn btn-sm bg-danger-light" onClick={() => apptOperation(appt.id,3)}>
                                                ...
                                                }
                                                {
                                                    (appt.status == 1) &&
                                                    <>
                                                    <a className="btn btn-sm bg-success-light" onClick={() => apptOperation(appt.id,2)}>
