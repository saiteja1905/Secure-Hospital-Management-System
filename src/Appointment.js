                                            ...
                                            <div className="appointment-list">
                                                <div className="profile-info-widget">
                                                    ...
                                                    <div className="profile-det-info">
                                                        <h3><a onClick={() => history.push("/PatientProfile/" + appt.patient_id)} className="bg-success-light">{appt.patient.username}</a></h3>
                                                        <div className="patient-details">
                                                            <h5><i className="far fa-clock"></i> {appt.d} {appt.m} {appt.y}, {appt.time}</h5>
                                                            <h5><i className="fas fa-map-marker-alt"></i> {appt.patient.address}
                                                            </h5>
                                                            <h5><i className="fas fa-envelope"></i> {appt.patient.email}</h5>
                                                            <h5 className="mb-0"><i className="fas fa-phone"></i> +1 {appt.patient.phone}</h5>
                                                        </div>
                                                    </div>
                                                </div>
