...
function AdminAppointmentsView() {
    ...
    return (
        <div className="main-wrapper">
            ...
            {
                disableAll && <div className="modal fade show" id="Loading details" aria-hidden="true" role="dialog" style={{display:"block"}}>
                    <div className="modal-dialog modal-dialog-centered" role="document">
                        <div className="modal-content">
                            <div className="modal-header">
                                <h5 className="modal-title">Loading info from db</h5>
                            </div>
                        </div>
                    </div>
                </div>
