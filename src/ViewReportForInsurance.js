...
function ViewReportForInsurance(){
                                    ...
                                    <div class="patient-info">
                                        ...
                                        <li>Appointment Date <span>{appt.d} {appt.m}, {appt.y}</span></li>
                                            ...
                                            <br></br>
                                            {
                                                ...
                                                <li>To accpet, mention the ammount that can be claimed!</li>
                                                <input type="number" className="form-control"  onChange={e => setApprovedAccount(e.target.value)}/>
                                                <a onClick={() => statusReqOperation(appt.id,2)}
                                                className="btn btn-sm bg-success-light">
                                                <i className="fas fa-check"></i> Accept
                                                </a>
                                                <a onClick={() => statusReqOperation(appt.id,3)}
...
export default ViewReportForInsurance;